...
public class GoodsController {
    ...
    public CategoryPageResponse getCategoryList(@RequestBody CategoryListQueryParam param) {
        return CategoryPageResponse.builder().code(200).msg("").pageNum(1L).pageSize(5L).total(100L).cateList(
                Arrays.asList(
                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("1").parentCateId("0").cateName("大家电").cateLevel("1").children(
                                Arrays.asList(
                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("11").parentCateId("1").cateName("电视").cateLevel("2").children(
                                                Arrays.asList(
                                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("111").parentCateId("11").cateName("曲面电视").cateLevel("3").build(),
                                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("112").parentCateId("11").cateName("透明电视").cateLevel("3").build()
                                                )
                                        ).build(),
                        ...
                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("3").parentCateId("0").cateName("海外购").cateLevel("1").children(
                                Arrays.asList(
                                        ...
                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("32").parentCateId("3").cateName("冰鲜").cateLevel("2").children(
                                                Arrays.asList(
                                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("321").parentCateId("32").cateName("水产").cateLevel("3").build(),
                                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("322").parentCateId("32").cateName("牛羊肉").cateLevel("3").build()
                                                )
                                        ).build()
                                )
                        ).build()
    ...
    public CategoryListResponse getParentCategoryList() {
        return CategoryListResponse.builder().code(200).msg("").parentCategoryList(Arrays.asList(
                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("1").parentCateId("0").cateName("大家电").cateLevel("1").children(
                                Arrays.asList(
                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("11").parentCateId("1").cateName("电视").cateLevel("2").build(),
                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("12").parentCateId("1").cateName("冰箱").cateLevel("2").build(),
                                        CategoryPageResponse.CategoryInfoDTO.builder().cateId("13").parentCateId("1").cateName("洗衣机").cateLevel("2").build()
                                )
                        ).build(),
